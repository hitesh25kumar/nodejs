    ...
    static getPostByUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const posts = yield Post_1.default.find({ user_id: userId }, { __v: 0, user_id: 0 }).populate('comments').skip((perPage * page) - perPage).limit(perPage);
                res.json({
                    post: posts,
                    pagetoken: pageToken,
    ...
    static getAllPosts(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const posts = yield Post_1.default.find({ __v: 0 }).populate('comments').skip((perPage * page) - perPage).limit(perPage);
